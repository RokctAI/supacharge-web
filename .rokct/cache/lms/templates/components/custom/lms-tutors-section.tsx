...
//
// The roster is a DECK, not a grid (Ray, 2026-09-08: "the tutor cards can
// still be a deck that take one row and can be swipped like in dart"): one
// row you swipe, the next card's edge always showing, exactly one card per
// swipe, position dots under it - lms/dart's CardDeck, as
// landing/lms-card-deck.tsx renders it for the web. Twelve tutors used to
// wrap into three or four rows of a grid and the assistants into another;
// each is now a single row that scrolls. The cards themselves are
// unchanged, flip included - the deck owns the row and never the card.
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 xl:px-0 max-w-6xl flex flex-col gap-12">
        ...
        <LmsCardDeck labels={config.deck}>
