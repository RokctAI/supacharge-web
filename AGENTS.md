# Agent build brief — supacharge-web
...
**supacharge-web** — Web shell for the Supacharge product — its web frontend, alongside the existing Flutter app repo.

Repo: `RokctAI/supacharge-web` (public)
Accepted from: https://github.com/RokctAI/factory/issues/127
